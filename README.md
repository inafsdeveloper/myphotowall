...
I am using this project to learn to create an react app with Firebase as backend.

You can ignore Below Documentation if you are aware of create-react-app.
